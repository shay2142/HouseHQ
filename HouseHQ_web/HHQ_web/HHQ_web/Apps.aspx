<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Apps.aspx.cs" Inherits="HHQ_web.WebForm4" %>
...
<body>
    <form id="form1" runat="server">
        <div id="mySidenav" class="sidenav" runat="server">
            ...
            <%--<asp:Button runat="server" class="mybtn" ID="Button3" Text="Manager" OnClick="btnMangar" />--%>
            <%--<asp:Button runat="server" class="mybtn" ID="btnLogin" Text="APPS" OnClick="btnApps" />--%>
            <%--<a href="#">Services</a>
            <a href="#">Clients</a>
            <a href="#">Contact</a>--%>
        </div>
        ...
        <div id="main">
            <span style="font-size: 30px; cursor: pointer" onclick="openAndClsoeNav()">&#9776;APPS</span>
            <h2 id="user1" runat="server">Sidenav Push Example</h2>
